...
<template>
  <DefaultAuthCard subtitle="Start for free" title="Sign Up to Access">
    <!-- Alerts -->
    ...
    <form @submit.prevent="submitForm">
      ...
      <div v-if="formErrors.username" class="text-red-500 text-sm">{{ formErrors.username }}</div>
      ...
      <div v-if="formErrors.email" class="text-red-500 text-sm">{{ formErrors.email }}</div>
      ...
      <div v-if="formErrors.password" class="text-red-500 text-sm">{{ formErrors.password }}</div>
      ...
      <div v-if="formErrors.confirmPassword" class="text-red-500 text-sm">{{ formErrors.confirmPassword }}</div>
